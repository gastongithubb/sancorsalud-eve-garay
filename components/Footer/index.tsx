  ...
  return (
    <>
      ...
      <div id="whatsapp-container" className="fixed z-50 bottom-4 right-4">
        <a href="https://api.whatsapp.com/send?phone=5493513818385" target="_blank" rel="noopener noreferrer" className="block transition-transform hover:scale-110" aria-label="Chat on WhatsApp">
        ...
        <div 
          className={`absolute right-0 w-64 p-4 bg-black text-white rounded-lg shadow-xl bottom-16 transition-opacity duration-300 ${
            showWhatsAppPopup ? 'opacity-100' : 'opacity-0 pointer-events-none'
          }`}
        >
          <p className="text-sm">Hola, soy Eve, cualquier duda que tengas, por favor consúltame así te puedo ayudar 😊</p>
        </div>
      </div>
